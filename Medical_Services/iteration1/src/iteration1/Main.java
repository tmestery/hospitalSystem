...
public class Main 
{
	...
	public static void main(String[] args) 
	{
        ...
        TestRequest created = sys.requests.stream().filter(r -> r.getRequestId().equals(reqId)).findFirst().get();
        System.out.println("\n=== Result ===");
        ...
        if (created.notes != null) System.out.println("Notes        : " + created.notes);
